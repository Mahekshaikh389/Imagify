...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center py-4' >
        <Link to="/">
          <img src={assets.logo} className=' w-28 sm:w-32 lg:w-48'/>
        </Link>
        ...
        <div>
            ...
            <div className='flex items-center gap-2 sm:gap-5'>
                <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-100 rounded-full px-4 sm:px-6 py-1.5 sm:py-3 hover:scale-105 transition-all duration-700'>
                    <img className='w-5' src={assets.credit_star} alt='' />
                    <p className='text-xs sm:text-sm font-medium text-gray-600'>Cradit laft: {credit}</p>
                </button>
